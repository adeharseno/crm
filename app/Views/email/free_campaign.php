...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style>
            ...
            .kmButtonBarContent,
            .kmButtonCollectionContent {
                font-family: "Helvetica Neue", Arial;
            }
            .kmVerticalButtonContent {
                border-collapse: separate;
            }
            .kmTable .kmTableRow > td:last-child {
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="kmImageContent" style="padding: 0;" valign="top">
                                                                                                <img
                                                                                                    ...
                                                                                                    alt=""
                                                                                                    class="kmImage"
                                                                                                    src="https://d3k81ch9hvuctc.cloudfront.net/company/YmSmGX/images/abedb597-b424-4d32-84ca-9edd3f07036c.jpeg"
                                                                                                    style="max-width: 1200px; padding: 0; border-width: 0;"
                                                                                                    width="582"
                                                                                                />
                                                                                            </td>
                                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="kmTextBlockInner" style="" valign="top">
                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="kmTextContent" style="padding-top: 9px; padding-bottom: 9px; padding-left: 18px; padding-right: 18px;" valign="top">
                                                                                                <h3 style="text-align: center;"></h3>
                                                                                                <h3 style="text-align: center;">Hi, <?= $nama ?>.</h3>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="kmImageContent" style="padding-top: 0px; padding-bottom: 0; padding-left: 9px; padding-right: 9px;" valign="top">
                                                                                                <img
                                                                                                    ...
                                                                                                    alt=""
                                                                                                    class="kmImage"
                                                                                                    src="https://d3k81ch9hvuctc.cloudfront.net/company/YmSmGX/images/7b8dad5f-92b4-4dc1-87e9-3a4ee1f0c0c8.jpeg"
                                                                                                    style="max-width: 1200px; padding: 0; border-width: 0;"
                                                                                                    width="546"
                                                                                                />
                                                                                            </td>
                                                                            ...
                                                                            <td class="kmTextBlockInner" style="" valign="top">
                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="kmTextContent" style="padding-top: 9px; padding-bottom: 9px; padding-left: 18px; padding-right: 18px;" valign="top">
                                                                                                <p style="text-align: center;"><span style="text-align: center;">Mungkin saja Anda salah satunya!</span></p>
