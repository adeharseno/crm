...
class Konfigurasi extends BaseController
{
	...
	public function termandcondition()
	{
		...
		if($this->request->getMethod() === 'post' && $this->validate(
			...
			$data = [	'id_konfigurasi'	=> $konfigurasi['id_konfigurasi'],
						'id_user'			=> $this->session->get('id_user'),
						'syaratketentuan'	=> $this->request->getPost('syaratketentuan')
					];
			$m_konfigurasi->edit($data);
			// masuk database
			$this->session->setFlashdata('sukses','Data telah diupdate');
			return redirect()->to(base_url('admin/konfigurasi/termandcondition'));
	    }else{
			$data = [	'title'			=> 'Konfigurasi Syarat & Ketentuan',
						'konfigurasi'	=> $konfigurasi,
						'content'		=> 'admin/konfigurasi/termandcondition'
					];
			echo view('admin/layout/wrapper',$data);
		}
	}
